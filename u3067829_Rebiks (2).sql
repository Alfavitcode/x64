...
--
-- Хост: localhost
-- Время создания: Май 31 2025 г., 14:18
...
(34, 10, 'n7qfcithdh79inrgs496u3tan3esh6j1', 'Михаил Калашников', 'reb@mail.ru', '+79053024129', 'аывваыаыв', 'ваыавывыа', 'ыавыав', 'ыавыав', 'card', 'courier', 300.00, 1900.00, 'closed', '', NULL, '2025-05-31 10:30:54', '2025-05-31 11:10:27');
...
--
ALTER TABLE `product`
  ADD CONSTRAINT `product_ibfk_1` FOREIGN KEY (`subcategory_id`) REFERENCES `categories` (`id`) ON DELETE SET NULL;
