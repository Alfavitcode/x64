<?php
/**
 * Простой класс для отправки писем через SMTP
 * Не требует PHPMailer с пространствами имен
 * 
 * Этот класс является простой заменой для случаев, когда стандартный PHPMailer не работает
 */
