    ...
    <footer class="footer bg-light mt-5 pt-5">
        <div class="container">
            <div class="row gy-4 mb-4">
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="footer__description text-muted mb-3">
                ...
                <div class="col-lg-3 col-md-6">
                    <h3 class="footer__title h5 mb-3 position-relative">Контакты</h3>
                    <ul class="footer__contacts list-unstyled">
                        <li class="mb-2 d-flex align-items-center text-secondary">
                            <i class="fas fa-map-marker-alt me-2 text-primary"></i> г. Москва, ул. Примерная, д. 123
                        </li>
                    ...
                    <div class="footer__payments d-flex flex-wrap gap-2 mt-3">
